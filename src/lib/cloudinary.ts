...
/**
 * Faz upload de uma imagem para o Cloudinary (preset unsigned) e devolve a URL pública.
 * Reutilizado tanto pelo gerador de links quanto pelo "Criar Minha Página".
 */
